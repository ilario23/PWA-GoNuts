...
export const changelogData: ChangeLogEntry[] = [
  {
    ...
    date: '2026-06-27',
    changes: [
      {type: 'feat', description: 'changelog_v2_2_3_0'},
      {type: 'feat', description: 'changelog_v2_2_3_1'},
    ],
  },
  {
    version: '2.2.2',
    date: '2026-06-23',
    changes: [
      {type: 'fix', description: 'changelog_v2_2_2_0'},
    ],
  },
  {
    version: '2.2.1',
    date: '2026-06-22',
    changes: [
      {type: 'feat', description: 'changelog_v2_2_1_0'},
      {type: 'fix', description: 'changelog_v2_2_1_1'},
      {type: 'fix', description: 'changelog_v2_2_1_2'},
      {type: 'feat', description: 'changelog_v2_2_1_3'},
    ],
  },
  {
    version: '2.2.0',
    date: '2026-06-16',
    changes: [
      {type: 'feat', description: 'changelog_v2_2_0_0'},
      {type: 'feat', description: 'changelog_v2_2_0_1'},
      {type: 'feat', description: 'changelog_v2_2_0_2'},
      {type: 'fix', description: 'changelog_v2_2_0_3'},
      {type: 'fix', description: 'changelog_v2_2_0_4'},
    ],
  },
  {
    version: '2.1.2',
    date: '2026-06-13',
    changes: [
      {type: 'refactor', description: 'changelog_v2_1_2_0'},
      {type: 'refactor', description: 'changelog_v2_1_2_1'},
    ],
  },
  {
    version: '2.1.1',
