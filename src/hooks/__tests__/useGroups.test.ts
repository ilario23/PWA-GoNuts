...
describe('useGroups', () => {
    ...
    it('should calculate group balance correctly', async () => {
        const mockMembers = [
            { id: 'member-1', group_id: 'group-1', user_id: 'user-1', share: 60, removed_at: null },
            { id: 'member-2', group_id: 'group-1', user_id: 'user-2', share: 40, removed_at: null },
        ];

        const mockTransactions = [
            { id: 'tx-1', group_id: 'group-1', type: 'expense', amount: 100, paid_by_user_id: 'user-1', deleted_at: null },
            { id: 'tx-2', group_id: 'group-1', type: 'expense', amount: 50, paid_by_user_id: 'user-2', deleted_at: null },
        ];
        ...
        (db.group_members.filter as jest.Mock).mockReturnValue(mockMemberFilterResult);
