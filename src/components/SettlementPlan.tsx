...
export function SettlementPlan({
    ...
    const generateShareText = () => {
        ...
        settlements.forEach((settlement, index) => {
            ...
            lines.push(
                `${index + 1}. ${fromLabel} → €${settlement.amount.toFixed(2)} → ${toLabel}`
            );
        });
            ...
            <CardContent className="p-4">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                        <UserAvatar userId={settlement.from} fallbackName={fromName} className="w-8 h-8" />
                    ...
                    <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
                        ...
                        <UserAvatar userId={settlement.to} fallbackName={toName} className="w-8 h-8" />
                    </div>
                </div>
